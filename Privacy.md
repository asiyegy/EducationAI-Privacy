...
This privacy policy applies to the Education AI app (hereby referred to as "Application") for mobile devices that was created by Asiye Güney (hereby referred to as "Service Provider") as a Freemium service. This service is intended for use "AS IS".
